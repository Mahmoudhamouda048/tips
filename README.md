...
|---------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------|:------------------------------:|:--------------------:|:----------:|:--------------:|:---------:|
| TIP&nbsp;10   | [TRON Token Standard](https://github.com/tronprotocol                                                                            |         | Standards&nbsp;Track |    Core    |     false      |   Final   |
| TIP&nbsp;37   | [TRON Event Subscription Model](https://github.com/tronprotocol                                                             Informational     |    TRC          Final   |
| TIP&nbsp;13   | [Design of TRON account](https://github.com/tronprotocol                                                         |     <justin@tron.network>      | Standards&nbsp;Track |    Core    |     false      |   Final   |
| TIP&nbsp;16   | [TRON Account Multi-Signature](https://github.com/                                    Standards&nbsp;Track |    Core    |      true      |   Final   |
...
| TIP&nbsp;204  | [Make MAX_FEE_LIMIT configurable as a chain property](https://github.com/tronprotocol/tips/blob/master/tip-204.md)                                            |     <yanghang8612@163.com>     | Standards&nbsp;Track |     VM                                                 |    <liu.sean@tron.network>     | Standards&nbsp;Track |    Core    |      true      |   Draft   |
